"""T4.route.nn — tuned PyTorch MLP for the `route` dataset (delay_s regression).

Run from this folder:
    MC_SMOKE=1 MC_THREADS=2 python nn_route.py      (smoke, <5 min)
    MC_THREADS=2 python nn_route.py                  (full run, T5 launches this)
...
# This file lives at models/route/nn_route.py -> parents[2] is model_comparison/, per protocol.
